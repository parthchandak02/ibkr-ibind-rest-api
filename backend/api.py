...
from .utils import get_ibkr_client, check_ibkr_health_status, get_cached_ibkr_client
...
# Initialize cached IBKR client on startup
logger.info(f"Initializing IBKR client for {TRADING_ENV} environment")
try:
    get_cached_ibkr_client(TRADING_ENV)
    logger.info("IBKR client initialization completed")
